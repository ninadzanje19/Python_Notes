...
#open an image
"""im = Image_processing.open("data\page_01.jpg")"""
...
#Invert an Image_processing's colours
inverted_image = cv2.bitwise_not(image)
#display an Image_processing(title, img obj)
"""cv2.imshow("Inverted Image_processing", inverted_image)"""
#Write an Image_processing(address, img obj)
...
cv2.imshow("Biniarized Image_processing", im_bw)
cv2.waitKey(0)